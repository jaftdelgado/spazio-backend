...
// @Description  Confirms the rental of an available property, commits the new transaction, and then generates the digital contract through the internal POST /api/v1/contracts/rent endpoint. Only accessible to authenticated clients.
// @Tags         Rentals
// @Accept       json
// @Produce      json
// @Param        Authorization  header    string                true  "Bearer access token"
