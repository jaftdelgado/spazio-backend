...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/payments": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Minimum due date in YYYY-MM-DD format",
                        "name": "date_from",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Maximum due date in YYYY-MM-DD format",
                        "name": "date_to",
                        "in": "query"
                    },
                    {
        ...
        "/api/v1/users/forgot-password": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Email that owns the account",
                        "name": "input",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/users.VerifyPasswordResetCodeInput"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/users.PasswordResetVerificationResult"
                        }
                    },
                    "400": {
                        "description": "Invalid request body",
        ...
        "/api/v1/users/logout": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "spazio_refresh_token=\u003ctoken\u003e",
                        "name": "Cookie",
                        "in": "header",
                        "required": true
                    }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/users.ConfirmEmailChangeInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/users/profile/email/request": {
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/users.RequestEmailChangeInput"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/users.VerifyEmailChangeInput"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/users.EmailChangeVerificationResult"
                        }
                    },
                    "400": {
                        "description": "Invalid request body",
        ...
        "/api/v1/users/staff": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Staff user data",
                        "name": "input",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/users.AdminCreateUserInput"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/users.AdminCreateUserResult"
                        }
                    },
                    "400": {
                        "description": "Invalid request body",
    ...
    "definitions": {
        ...
        "users.EmailChangeVerificationResult": {
            "type": "object",
            "properties": {
                "verification_token": {
                    "type": "string",
        ...
        "users.LoginResult": {
            ...
            "properties": {
                ...
                "refresh_token": {
                    "type": "string",
                    "example": "4e9a58788701fce52001214130c15ac8..."
                },
                "user": {
                    "$ref": "#/definitions/users.AuthUser"
                }
        ...
        "users.PasswordResetVerificationResult": {
            "type": "object",
            "properties": {
                "reset_token": {
                    "type": "string",
        ...
        "users.RefreshResult": {
            ...
            "properties": {
                ...
                "refresh_token": {
                    "type": "string",
                    "example": "9f3b12788701fce52001214130c15ac8..."
                }
            }
        },
        ...
        "users.VerifyPasswordResetCodeInput": {
            "type": "object",
            "required": [
                "code",
                "email"
